...
#'
#' This function is useful for finding the two sided confidence interval for the IQR of a data set, for which the t.test command cannot be used.
#'
...
bootstrap.IQR.confidence <- function(mydata, conf.level=0.95, replicates=10000) {
