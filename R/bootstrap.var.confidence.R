...
#'
#' This function is useful for finding the two sided confidence interval for the VARIANCE of a data set
#'
...
bootstrap.var.confidence <- function(mydata, conf.level=0.95, replicates=10000) {
